...
async def event_ready():
    os.system('cls||clear')
    print(intro)
    print(Fore.GREEN + ' [+] ' + Fore.RESET + 'Client ready as ' + Fore.LIGHTYELLOW_EX + f'{client.user.display_name}')
...
async def event_party_invite(invite):
    if data['joinoninvite'].lower() == 'true':
        ...
        await client.party.me.set_emote(asset=data['eidinvite'])
        await asyncio.sleep(20.25)
...
async def event_friend_request(request):
    if data['friendaccept'].lower() == 'true':
        ...
        await client.party.me.set_emote(asset=data['eidcustom'])
...
async def event_party_member_join(member):
    if client.user.display_name != member.display_name:
        ...
        await asyncio.sleep(0.5)
        await client.party.me.set_emote(asset=data['eidjoin'])
        await asyncio.sleep(15.25)
        await client.party.me.clear_emote()
        await asyncio.sleep(10.5)
        await client.party.me.set_emote(asset=data['eidcustom'])
...
async def event_party_member_leave(member):
    if client.user.display_name != member.display_name:
        ...
        await asyncio.sleep(0.5)
        await client.party.me.set_emote(asset=data['eidleave'])
...
async def event_friend_message(message):
    ...
    if message.content.upper().startswith('CID_'):
        ...
        await message.reply(f'Skin set to: {message.content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif message.content.upper().startswith('BID_'):
        await client.party.me.set_backpack(asset=message.content.upper())
        await message.reply(f'Backpack set to: {message.content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif message.content.upper().startswith('EID_'):
        await client.party.me.set_emote(asset=message.content.upper())
        await message.reply(f'Emote set to: {message.content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif message.content.upper().startswith('PID_'):
        await client.party.me.set_pickaxe(asset=message.content.upper())
        await message.reply(f'Pickaxe set to: {message.content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif message.content.startswith('Playlist_'):
        try:
            await client.party.set_playlist(playlist=message.content)
            await message.reply(f'Playlist set to: {message.content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        except fortnitepy.Forbidden:
            await message.reply(f"I can not set gamemode because I am not party leader. | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy")
    elif message.content.lower().startswith('prefix'):
        await message.reply(f'Current prefix: {prefix} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')


@client.event
async def event_command_error(ctx, error):
    if isinstance(error, commands.CommandNotFound):
        await ctx.send(f'That is not a command. Try {prefix}help | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif isinstance(error, IndexError):
        pass
    elif isinstance(error, fortnitepy.HTTPException):
        pass
    elif isinstance(error, commands.CheckFailure):
        await ctx.send("You don't have access to that command. | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy")
    elif isinstance(error, TimeoutError):
        await ctx.send("You took too long to respond! | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy")
    else:
        print(error)
...
async def skin(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No skin was given, try: {prefix}skin (skin name) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif content.upper().startswith('CID_'):
        await client.party.me.set_outfit(asset=content.upper())
        await ctx.send(f'Skin set to: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    else:
        try:
            ...
            await ctx.send(f'Skin set to: {cosmetic.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a skin named: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')


@client.command()
async def backpack(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No backpack was given, try: {prefix}backpack (backpack name) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif content.lower() == 'none':
        await client.party.me.clear_backpack()
        await ctx.send('Backpack set to: None | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif content.upper().startswith('BID_'):
        await client.party.me.set_backpack(asset=content.upper())
        await ctx.send(f'Backpack set to: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'Backpack set to: {cosmetic.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a backpack named: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')


@client.command()
async def emote(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No emote was given, try: {prefix}emote (emote name) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif content.lower() == 'floss':
        await client.party.me.clear_emote()
        await client.party.me.set_emote(asset='EID_Floss | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        await ctx.send(f'Emote set to: Floss | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif content.lower() == 'none':
        await client.party.me.clear_emote()
        await ctx.send(f'Emote set to: None | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif content.upper().startswith('EID_'):
        await client.party.me.clear_emote()
        await client.party.me.set_emote(asset=content.upper())
        await ctx.send(f'Emote set to: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'Emote set to: {cosmetic.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find an emote named: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')


@client.command()
async def pickaxe(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No pickaxe was given, try: {prefix}pickaxe (pickaxe name) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif content.upper().startswith('Pickaxe_'):
        await client.party.me.set_pickaxe(asset=content.upper())
        await ctx.send(f'Pickaxe set to: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'Pickaxe set to: {cosmetic.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a pickaxe named: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')


@client.command()
async def pet(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No pet was given, try: {prefix}pet (pet name) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif content.lower() == 'none':
        await client.party.me.clear_pet()
        await ctx.send('Pet set to: None | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'Pet set to: {cosmetic.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a pet named: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')


@client.command()
async def emoji(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No emoji was given, try: {prefix}emoji (emoji name) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    try:
        cosmetic = await BenBotAsync.get_cosmetic(
            lang="en",
            searchLang="en",
        ...
        await ctx.send(f'Emoji set to: {cosmetic.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    except BenBotAsync.exceptions.NotFound:
        await ctx.send(f'Could not find an emoji named: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def current(ctx, setting = None):
    if setting is None:
        await ctx.send(f"Missing argument. Try: {prefix}current (skin, backpack, emote, pickaxe, banner) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy")
        ...
        try:
            ...
            await ctx.send(f"My current {setting} is: {cosmetic.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy")
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f"I couldn't find a {setting} name for that. | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy")
...
async def name(ctx, *, content=None):
    if content is None:
        await ctx.send(f'No ID was given, try: {prefix}name (cosmetic ID) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic_from_id(
                cosmetic_id=content
            )
            await ctx.send(f'The name for that ID is: {cosmetic.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
            print(f' [+] The name for {cosmetic.id} is: {cosmetic.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a cosmetic name for ID: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy ')
...
async def cid(ctx, *, content = None):
    if content is None:
        await ctx.send(f'No skin was given, try: {prefix}cid (skin name) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'The CID for {cosmetic.name} is: {cosmetic.id} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
            print(f' [+] The CID for {cosmetic.name} is: {cosmetic.id} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a skin named: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def bid(ctx, *, content):
    if content is None:
        await ctx.send(f'No backpack was given, try: {prefix}bid (backpack name) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'The BID for {cosmetic.name} is: {cosmetic.id} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
            print(f' [+] The BID for {cosmetic.name} is: {cosmetic.id} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find a backpack named: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def eid(ctx, *, content):
    if content is None:
        await ctx.send(f'No emote was given, try: {prefix}eid (emote name) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    elif content.lower() == 'floss':
        ...
        try:
            ...
            await ctx.send(f'The EID for {cosmetic.name} is: {cosmetic.id} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
            print(f' [+] The EID for {cosmetic.name} is: {cosmetic.id} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        except BenBotAsync.exceptions.NotFound:
            await ctx.send(f'Could not find an emote named: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def pid(ctx, *, content):
    if content is None:
        await ctx.send(f'No pickaxe was given, try: {prefix}pid (pickaxe name) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    else:
        try:
            cosmetic = await BenBotAsync.get_cosmetic(
                lang="en",
            ...
            await ctx.send(f'The PID for {cosmetic.name} is: {cosmetic.id} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def random(ctx, content = None):
    ...
    if content is None:
        ...
        if content.lower() == 'skin':
            ...
            await ctx.send(f'Skin randomly set to: {skin.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')

        elif content.lower() == 'backpack':
            await client.party.me.set_backpack(asset=backpack.id)
            await ctx.send(f'Backpack randomly set to: {backpack.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')

        elif content.lower() == 'emote':
            await client.party.me.set_emote(asset=emote.id)
            await ctx.send(f'Emote randomly set to: {emote.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')

        elif content.lower() == 'pickaxe':
            await client.party.me.set_pickaxe(asset=pickaxe.id)
            await ctx.send(f'Pickaxe randomly set to: {pickaxe.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
    ...
    if content is None:
        ...
        if content.upper().startswith('Pickaxe_'):
            ...
            try:
                ...
                await client.party.me.clear_emote()
                await client.party.me.set_emote(asset='EID_IceKing')
                await ctx.send(f'Pointing with: {cosmetic.name} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
            except BenBotAsync.exceptions.NotFound:
                await ctx.send(f'Could not find a pickaxe named: {content} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def checkeredrenegade(ctx):
    ...
    await ctx.send('Skin set to: Checkered Renegade | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def pinkghoul(ctx):
    ...
    await ctx.send('Skin set to: Pink Ghoul Trooper | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def purpleskull(ctx):
    ...
    await ctx.send('Skin set to: Purple Skull Trooper | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def purpleportal(ctx):
    ...
    await ctx.send('Backpack set to: Purple Ghost Portal | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def goldpeely(ctx):
    ...
    await ctx.send('Skin set to: Golden Peely | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def hatlessrecon(ctx):
    ...
    await ctx.send('Skin set to: Hatless Recon Expert | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def hologram(ctx):
    ...
    await ctx.send("Skin set to: Hologram | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy")
...
async def itemshop(ctx):
    ...
    await ctx.send("Equipping all item shop skins + emotes | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy")
    ...
    await ctx.send("Done! | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy")
...
async def new(ctx, content = None):
    ...
    if content is None:
        await ctx.send(f'There are {len(newSkins) + len(newEmotes)} new skins + emotes | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def unready(ctx):
    ...
    await ctx.send('Unready! | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def sitin(ctx):
    await client.party.me.set_ready(fortnitepy.ReadyState.NOT_READY)
    await ctx.send('Sitting in | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
...
async def banner(ctx, args1 = None, args2 = None):
    if (args1 is not None) and (args2 is None):
        if args1.startswith('defaultcolor'):
            ...
            await ctx.send(f'Banner color set to: {args1} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
            ...
            await ctx.send(f'Banner color set to: defaultcolor{args1} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
            ...
            await ctx.send(f'Banner Icon set to: {args1} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
        ...
        if args2.startswith('defaultcolor'):
            ...
            await ctx.send(f'Banner icon set to: {args1} -- Banner color set to: {args2} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
            ...
            await ctx.send(f'Banner icon set to: {args1} -- Banner color set to: defaultcolor{args2} | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')

        else:
            await ctx.send(f'Not proper format. Try: {prefix}banner (Banner ID) (Banner Color ID) | discord.gg/azeVGJw | Queen Svaxyy#4598 | Lobby Bot by Svaxyy')
